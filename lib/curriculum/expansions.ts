...
import {
  applyWave4Expansions,
  wave4ClinicalCases,
  wave4Flashcards,
  wave4Objectives,
  wave4QbankQuestions,
  wave4QuizQuestions,
} from "@/lib/curriculum/expansions-wave4";
import {
  applyWave5Expansions,
  wave5ClinicalCases,
  wave5Flashcards,
  wave5Objectives,
  wave5QbankQuestions,
...
import {
  applyWave7Expansions,
  wave7ClinicalCases,
  wave7Flashcards,
  wave7Objectives,
  wave7QbankQuestions,
  wave7QuizQuestions,
} from "@/lib/curriculum/expansions-wave7";
import {
  applyFourYearCatalog,
  catalogFlashcards,
  catalogObjectives,
  catalogQuizQuestions,
} from "@/lib/curriculum/catalog/apply";
...
export function applyCurriculumExpansions(program: Program): Program {
  ...
  applyWave7Expansions(program);
  applyFourYearCatalog(program);
